## Create a graph using plot() for energy sub metering for the
...
## recreate the plot3 graph as shown in the github fork
...
with(tdm, plot(tdm$datetime, tdm$Sub_metering_1, type = "l", col = "black", 
     ylab = "Energy sub metering", xlab = "", bg = "white"))
with(tdm, points(tdm$datetime, tdm$Sub_metering_2, type = "l", col = "red"))
with(tdm, points(tdm$datetime, tdm$Sub_metering_3, type = "l", col = "blue"))
with(tdm, legend("topright", lty=c(1,1,1), col = c("black", "red", "blue"), legend = 
